      ...
      <div className="entete">
        <h3 className="titre">À Propos</h3>
          <p>
            ...
            titulaire d'une licence en Communication. Vous pouvez m'écrire à
            cette adresse {" "}
      ...
      <div className="contenu">
        ...
        <div className="services">
          <div className="frontend digit">
            ...
            <div className="icons">
              <p>
                Vous cherchez un expert pour optimiser la gestion de vos pages
                sur les médias sociaux et augmenter leur visibilité ? Je suis la
